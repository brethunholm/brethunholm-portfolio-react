...
const data = {
    outstandingly: {
        ...
        I enjoyed working on this project and having the opportunity to take on a leadership role. I learned a lot about GatsbyJS and how it works with React to make sites even faster and render images more efficiently. 
   ...
   wedding: {
        ...
        headerParagraph: `This site was a freelance contract for a newly engaged couple. The goal of this project was to create a custom-designed and mobile responsive landing page that provided event details for the upcoming wedding, registry information, and a photo gallery.`,
        bottomParagraph: `

        I created this website from concept to launch using Figma for initial design mockups and coded on Visual Studio Code. I built the site using React and created reusable components with future use in mind. Keeping in mind that the site would likely be accessed on mobile devices by wedding guests, the website was designed using mobile-first design philosophy. I implemented CSS grid and grid template areas and custom media queries to adjust the layout of the content for optimal user experience. 
