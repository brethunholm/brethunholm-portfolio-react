...
const data = {
   ...
   wedding: {
        ...
        Responsive, uses grid template area to change layout for mobile experience. Countdown clock written with javascript, custom rsvp form created using formik. Image gallery and registry. Blog style guest book.
    ...
    meditation: {
        ...
        headerParagraph: `Self guided meditation resource.  The webpage has 4 different Mantras for users to repeat to themselves. Built with React and CSS Flexbox.  `,
